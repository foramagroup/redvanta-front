        ...
        <motion.div variants={fadeUp} custom={1} className="mt-8 rounded-2xl border border-border/50 bg-gradient-card p-8 shadow-2xl backdrop-blur">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input className="mt-2 border-border/50 bg-background text-foreground" placeholder="John Smith" />
            </div>
            <div>
              <label className="text-sm font-medium text-muted-foreground">{t("signup.business_email")}</label>
              <Input className="mt-2 border-border/50 bg-background text-foreground" placeholder="you@company.com" type="email" />
            </div>
            <div>
              <label className="text-sm font-medium text-muted-foreground">{t("signup.business_name")}</label>
              <Input className="mt-2 border-border/50 bg-background text-foreground" placeholder="Your Business" />
            </div>
            <div>
            ...
            <Button className="glow-red-hover w-full bg-primary text-primary-foreground hover:bg-primary/90">
