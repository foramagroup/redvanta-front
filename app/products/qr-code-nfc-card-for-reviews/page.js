...
import {
  ...
  Minus, Plus, Settings, Lock, Truck, Play,
  ...
  return (
    <div className="bg-gradient-dark pt-32">
        ...
        <div className="container mx-auto px-6">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <motion.div initial="hidden" animate="visible">
              ...
              {selectedBundle === 0 && (
                <motion.div variants={fadeUp} custom={products.length > 1 ? 5 : 4} className="mt-8">
              ...
              <motion.div variants={fadeUp} custom={products.length > 1 ? 6 : 5} className="mt-8 flex flex-col items-start gap-3">
                 <Button
                   size="lg"
      ...
      <ConfiguratorModal
        ...
        unitPrice={totalPrice / totalQty}
        packageLabel={currentBundle?.label || productTitle}
        productId={productId}
        packageTierId={currentBundle?.id || null}
