...
test.describe('Flows avancés: auth, edit product, checkout', () => {
  ...
  test('create then edit product (mocked endpoints)', async ({ page, baseURL }) => {
    ...
    await page.route('**/api/admin/products/p123', async route => {
    ...
    const res = await page.request.put(`${page.context().baseURL || baseURL}/api/admin/products/p123`, { data: { title: "Updated Title", slug: "pw-prod", priceCents: 1250, description: "desc updated" }});
